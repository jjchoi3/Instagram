...
extension Array{
    //Divides arrays into specified subarrays
...
extension String{
    //Splits strings to array in pyramid-hierarchy
    ...
    func removeWhiteSpaces()-> String{
        let string = String(self.filter{ !" \n\t\r".contains($0)})
        return string
    }
}


//Converts encrypted data to JSON or dictionary data
extension Encodable{
...
//Converts JSON or dictionary data to callable data
extension Decodable{
...
extension Color{
    ...
    static let instagram: [Color] = [
        ...
        Color(red: 245/255, green: 96/255, blue: 264/255),
